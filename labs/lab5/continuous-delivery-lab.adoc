...
. Login to your Jenkins instance if you already have one. Alternatively you can quickly start jenkins instance by following https://hub.docker.com/r/jenkins/jenkins/. Make sure Git and Gradle plugin are installed.
